...
//		}
		...
		By clickOnCareer = By.xpath("//android.widget.TextView[@text='Careers']");
		WebElement clickOnCareerl = driver.findElement(clickOnCareer);
		clickOnCareerl.isDisplayed();
		clickOnCareerl.click();
		Thread.sleep(2000);
		
		By isdisplayDevopsEngineer = By.xpath("//android.widget.TextView[@text='Devops engineer with AWS']");
		WebElement isdisplayDevopsEngineerl = driver.findElement(isdisplayDevopsEngineer);
		isdisplayDevopsEngineerl.isDisplayed();
		String textdata = isdisplayDevopsEngineerl.getText();
		System.out.println(textdata);
		String Exptextdata = "Devops engineer with AWS";
		isdisplayDevopsEngineerl.click();
		Assert.assertEquals(textdata, Exptextdata, "test case pass");
         Thread.sleep(3000);
         By clickonBackButton=By.xpath("//android.widget.TextView[@text='Joey Rooms']");
         WebElement clickonbackbuttonl=driver.findElement(clickonBackButton);
         String actualtext=clickonbackbuttonl.getText();
         System.out.println(actualtext);
         String Exptext="Joey Rooms";
         //System.out.println(actualtext);
         Assert.assertEquals(actualtext, actualtext,"test case pass");
         Thread.sleep(2000);
         By listofcareerpage=By.xpath("//android.view.ViewGroup[@bounds='[28,182][692,1465]']");
         List<MobileElement>listofdata=driver.findElements(listofcareerpage);
         MobileElement lisdata=listofdata.get(0);
         String data=lisdata.getText();
