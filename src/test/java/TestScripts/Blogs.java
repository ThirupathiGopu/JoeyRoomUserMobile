...
//		}
        ...
        Thread.sleep(2000);
        By Blogs=By.xpath("//android.widget.TextView[@text='Blogs']");
        WebElement Blogsl=driver.findElement(Blogs);
        Blogsl.click();
        Thread.sleep(2000);
        By isdisplayVisitHyderabad=By.xpath("//android.widget.TextView[@text='Places To Visit In Hyderabad']");
        WebElement isdisplayVisitHyderabadl=driver.findElement(isdisplayVisitHyderabad);
        isdisplayVisitHyderabadl.isDisplayed();
        String textdata=isdisplayVisitHyderabadl.getText();
        System.out.println(textdata);
        String Exptextdata="Places To Visit In Hyderabad";
        Assert.assertEquals(textdata, Exptextdata, "test case pass");
        isdisplayVisitHyderabadl.click();
        Thread.sleep(2000);
        By blogDetails=By.xpath("//android.widget.TextView[@text='Blog Detail']");
        WebElement blogDetailslElement=driver.findElement(blogDetails);
       String blogstext= blogDetailslElement.getText();
       System.out.println(blogstext);
       String expblogs="Blog Detail";
       Thread.sleep(3000);
       By backbutton=By.xpath("//android.view.ViewGroup[@bounds='[19,66][98,144]']");
       WebElement backbuttonl=driver.findElement(backbutton);
       backbuttonl.isDisplayed();
       backbuttonl.click();
