...
public class MediaCoveragepage 
{
...
//		}
		...
		By clickOnMediaCoverage = By.xpath("//android.widget.TextView[@text='Media Coverage']");
		WebElement clickOnMediaCoveragel = driver.findElement(clickOnMediaCoverage);
		clickOnMediaCoveragel.isDisplayed();
		clickOnMediaCoveragel.click();
		Thread.sleep(2000);
		
		By isdisplayBenguarinside = By.xpath("//android.widget.TextView[@text='Bangalore Insider News']");
		WebElement isdisplayDevopsEngineerl = driver.findElement(isdisplayBenguarinside);
		isdisplayDevopsEngineerl.isDisplayed();
		String textdata = isdisplayDevopsEngineerl.getText();
		System.out.println(textdata);
		String Exptextdata = "Bangalore Insider News";
		isdisplayDevopsEngineerl.click();
		Assert.assertEquals(textdata, Exptextdata, "test case pass");
         Thread.sleep(3000);
        
         By textofJoeyroomProviding=By.xpath("//android.widget.TextView[@text='JoeyRooms: Providing Online Visibility For Hostels And PGs']");
         WebElement textofJoeyroomProvidingl=driver.findElement(textofJoeyroomProviding);
        String text= textofJoeyroomProvidingl.getText();
        System.out.println(text);
        String exptext="JoeyRooms: Providing Online Visibility For Hostels And PGs";
