...
//		}
		...
		Thread.sleep(2000);
		By Notification = By.xpath("//android.widget.TextView[@text='Notifications']");
		WebElement Notificationl = driver.findElement(Notification);
		Notificationl.isDisplayed();
		Notificationl.click();
		Thread.sleep(2000);
		MobileElement elementer= (MobileElement) driver.findElement(MobileBy.AndroidUIAutomator(
		        "new UiScrollable(new UiSelector().scrollable(true))" +
		         ".scrollIntoView(new UiSelector().text(\"Your schedule visit is accepted\"))"));
		By isdisplayschedulevisit = By.xpath("//android.widget.TextView[@text='Your schedule visit is accepted']");
		WebElement isdisplayschedulevisitl = driver.findElement(isdisplayschedulevisit);
		isdisplayschedulevisitl.isDisplayed();
		String textdata = isdisplayschedulevisitl.getText();
		System.out.println(textdata);
		String Exptextdata = "Your schedule visit is accepted";
