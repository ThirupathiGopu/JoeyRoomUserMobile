...
public class BookingHistory 
{
	...
	@BeforeTest
	 ...
	 @Test
	 public void clickonbookingHistory() throws Exception
	 {
        ...
        Thread.sleep(3000);
        By bookinghistory=By.xpath("//android.widget.TextView[@text='Booking History']");
        WebElement bookinghostoryl=driver.findElement(bookinghistory);
        bookinghostoryl.isDisplayed();
        bookinghostoryl.click();
