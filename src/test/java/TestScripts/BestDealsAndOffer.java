...
public class BestDealsAndOffer 
{
	...
	@BeforeTest
	 ...
	 @Test
	 public void ClickOnBestDealsAndOffers() throws Exception
	 {
...
//		}
        ...
        Thread.sleep(2000);
        By bestdealsofferBy=By.xpath("//android.widget.TextView[@text='Best Deals']");
        WebElement bestdealsofferlElement=driver.findElement(bestdealsofferBy);
        bestdealsofferlElement.click();
        Thread.sleep(2000);
        By isdisplayDealsAndOfferTex=By.xpath("//android.widget.TextView[@text='Best deals and Offers']");
        WebElement isdisplayDealsAndOfferTexl=driver.findElement(isdisplayDealsAndOfferTex);
        isdisplayDealsAndOfferTexl.isDisplayed();
        String textdata=isdisplayDealsAndOfferTexl.getText();
        System.out.println(textdata);
        String Exptextdata="Best deals and Offers";
