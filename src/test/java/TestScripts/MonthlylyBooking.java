	...
	@BeforeTest
	 ...
	 public void LoginwithpasswordAndDailybookingpayment() throws IOException, InterruptedException 
	 {
		 ...
		 if(monthlyl.isDisplayed())
			{
				...
				By monthlyLinkl=By.xpath("//android.widget.TextView[@text='Monthly']");
		...
		else 
		{
			    weeklyl.click();	
				System.out.println("sucessfully enter to home page");
				By weeklkyLtxt=By.xpath("//android.widget.TextView[@text='Weekly']");
		 ...
		 MobileElement elemen = (MobileElement) driver.findElement(MobileBy.AndroidUIAutomator(
			        "new UiScrollable(new UiSelector().scrollable(true))" +
			         ".scrollIntoView(new UiSelector().text(\"JR311 Siva Hotal shared property\"))"));
		 Thread.sleep(4000);
		 By JKReddyhsl=By.xpath("//android.widget.TextView[@text='JR712 SVSLodge']");
		 WebElement JKReddyhslL=driver.findElement(JKReddyhsl);
		 JKReddyhslL.isDisplayed();
		 JKReddyhslL.click();
		 Thread.sleep(4000);
		 ...
		 Thread.sleep(4000);
//		 MobileElement elemenents1 = (MobileElement) driver.findElement(MobileBy.AndroidUIAutomator(
//			        "new UiScrollable(new UiSelector().scrollable(true))" +
//			         ".scrollIntoView(new UiSelector().text(\"NCRroom (Non-Ac)\"))"));
//		 Thread.sleep(3000);
//		 By reachroom=By.xpath("//android.widget.TextView[@TEXT='RWS (AC)']");
//		 WebElement reachrooml=driver.findElement(reachroom);
//		 reachrooml.isDisplayed();
//		 String text=reachrooml.getText();
//		 System.out.println(text);
		 ...
		 addroombtnl.click();
         Thread.sleep(3000);
		 By selectbutton=By.xpath("//android.widget.TextView[@text='Select']");
